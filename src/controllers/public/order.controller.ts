// src/controllers/public/order.controller.ts
...
export class PublicOrderController {
  ...
  static async store(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      ResponseUtil.success(res, formattedOrder, 'Order created successfully', 201);
    } catch (error: any) {
  ...
  static async show(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      const order = await OrderService.getOrderById(req.params.id, req.user?.isAdmin ? undefined : req.user.id);
  ...
  static async cancel(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      ...
      ResponseUtil.success(res, formattedOrder, 'Order cancelled successfully');
    } catch (error: any) {
